...
**15 ·** `feat(tienda): disenar la pantalla de inicio`
...
**16 ·** `feat(tienda): armar el inicio y mover la carta a /shop`
...
**17 ·** `feat(tienda): mostrar las pizzas y las focaccias`
...
**18 ·** `feat(tienda): mostrar las empanadas por pack`

Van aparte porque no tienen precio propio: se cobran por pack de 6 o de 12, de un solo gusto.

**19 ·** `feat(tienda): sumar los dibujos y agrandar el logo`
...
**20 ·** `feat(tienda): contar y sumar productos al pedido`
...
**27 ·** `feat(tienda): mostrar la confirmación`

Qué pidió, cuánto sale y qué pasa ahora — que él escribe por WhatsApp.

**28 ·** `feat(tienda): mostrar la tienda cerrada`
...
**29 ·** `feat(panel): entrar al panel con una clave`
...
**30 ·** `feat(panel): armar la barra lateral y la cabecera`
...
**31 ·** `feat(panel): listar los pedidos`

La pantalla que va a mirar todos los días.

**32 ·** `feat(panel): ver el detalle de un pedido`
...
**33 ·** `feat(panel): avanzar y cancelar el estado del pedido`
...
**34 ·** `feat(app): avisar el pedido nuevo por Telegram`
...
**35 ·** `feat(panel): contar la producción del finde`

Los tres titulares: cuántos bollos, cuántas empanadas, cuántos pedidos.

**36 ·** `feat(panel): desglosar la producción por producto`
...
**39 ·** `feat(panel): dar de alta un producto`

El alta al pie de la lista, con el botón redondo.

**40 ·** `feat(panel): cargar la receta de un producto`
...
**51 ·** `feat(panel): abrir y cerrar la tienda`
...
**52 ·** `chore(app): preparar el deploy en Railway`
